...
//        view.addSubview(playerDetailsView)
    ...
    func setupViewControllers() {
        ...
        let podcastSearchController = PodcastsSearchController()
        let searchPresenter = PodcastSearchPresenter()
        podcastSearchController.presenter = searchPresenter
        let favoritePresenter = FavoritesPresenter()
        favoritesController.presenter = favoritePresenter
        let downloadsController = DownloadsController()
        let downloadsPresenter = DownloadsPresenter()
        downloadsController.presenter = downloadsPresenter
        viewControllers = [
